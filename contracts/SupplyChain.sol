...
contract SupplyChain {
    ...
    modifier verifyCaller(address _address) {
        require(msg.sender == _address, "Caller is not same as given address");
        _;
    }
        ...
        checkValue(sku)
    {
        ...
        (bool sent, bytes memory data) = item.seller.call.value(item.price)("");
